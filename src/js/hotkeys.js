...
function hotkeys(options) {
  ...
  const enableHoverScroll = options.enableHoverScroll;
  ...
  const captureDocumentHotkeys = options.captureDocumentHotkeys;
  const documentHotkeysFocusElementFilter = options.documentHotkeysFocusElementFilter;
  const enableModifiersForNumbers = options.enableModifiersForNumbers;
  const enableInactiveFocus = options.enableInactiveFocus;
  const skipInitialFocus = options.skipInitialFocus;

  const videojsVer = videojs.VERSION;
...
Plugin.registerPlugin('hotkeys', hotkeys);
